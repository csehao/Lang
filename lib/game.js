...
class GameFactory{
    ...
    */
    createGame(settings) {
        ...
        return new Game().createGame(judgeFactory, characterListFactory);
    }
}
...
class Game {
    ...
    */
   createGame(judgeFactory, characterListFactory){
       ...
       return this.setJudge(judge).setCharacterList(characters);
   }
   setJudge(judge){
     this.judge = judge;
     return this;
